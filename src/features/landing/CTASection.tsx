...
export function CTASection() {
    return (
        <div className="py-24 bg-[var(--color-background-alt)] border-t border-gray-100">
            <div className="max-w-4xl mx-auto px-4 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button
                        ...
                        className="px-8 py-3.5 rounded-full bg-[var(--color-brand)] text-white font-semibold hover:bg-[var(--color-brand-dark)] transition-all shadow-lg shadow-blue-500/25 flex items-center gap-2"
                    >
                        Get Started Now
